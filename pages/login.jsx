      ...
      <main className="w-full h-screen flex flex-col items-center justify-center px-4">
        <div className="max-w-sm w-full text-gray-600 space-y-5">
          <div className="text-center pb-8">
            ...
            <hr></hr>
            <div className="mt-5">
              <h3 className="text-gray-800 dark:text-gray-300 text-2xl font-bold sm:text-3xl">Inicia sesión en tu cuenta</h3>
            </div>
          </div>
          <form
          ...
          >
            ...
            <div className="flex items-center justify-between text-sm">
              <div className="flex items-center gap-x-3">
                ...
                <span className="dark:text-gray-300">Recordarme</span>
              </div>
              <a href="javascript:void(0)" className="text-center text-indigo-600 hover:text-indigo-500">Olvidaste tu contraseña?</a>
            </div>
            <button
