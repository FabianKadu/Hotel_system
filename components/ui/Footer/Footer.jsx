        ...
        <footer className="text-gray-600 bg-gray-100 px-6 py-8 mx-auto md:px-8">
            ...
            <div className="mt-8 sm:flex sm:justify-between sm:items-center">
                ...
                <div className="mt-6 sm:mt-0 flex justify-center space-x-4">
                    ...
                    <a href="javascript:void(0)" className="w-10 h-10 border rounded-full flex items-center justify-center text-blue-700 hover:bg-blue-700 hover:text-white transition-colors duration-300">
                        <svg className="w-6 h-6" viewBox="0 0 20 20">
                    ...
                    <a href="javascript:void(0)" className="w-10 h-10 border rounded-full flex items-center justify-center text-red-600 hover:bg-red-600 hover:text-white transition-colors duration-300">
                        <svg className="w-6 h-6" viewBox="0 0 20 20">
