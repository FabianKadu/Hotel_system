        ...
        <div class="max-w-sm rounded overflow-hidden shadow-lg bg-white">
            ...
            <div class="px-6 py-4">
                <div class="flex items-center justify-between">
                    <div class="font-bold text-xl">Habitación 101</div>
                ...
                <div class="flex items-center mt-4 space-x-4 text-gray-600">
                    <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3.5" stroke="currentColor" class="w-5 h-5 text-blue-500">
                    ...
                    <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3.5" stroke="currentColor" class="w-5 h-5 text-green-500">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.75l.924 1.894a1.125 1.125 0 00.846.616l2.082.303-1.506 1.468a1.125 1.125 0 00-.324.996l.355 2.068-1.86-.978a1.125 1.125 0 00-1.048 0l-1.86.978.355-2.068a1.125 1.125 0 00-.324-.996L8.148 9.563l2.082-.303a1.125 1.125 0 00.846-.616L12 6.75z" />
                        </svg>
                    ...
                    <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3.5" stroke="currentColor" class="w-5 h-5 text-red-500">
            ...
            <div class="px-6 pt-4 pb-6">
                <div class="flex items-center justify-between">
                    <span class="text-gray-900 font-bold text-xl">S/. 58.00 / noche</span>
